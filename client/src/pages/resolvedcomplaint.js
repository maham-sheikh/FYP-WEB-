...
const ComplaintsResolved = () => {
    const resolvedComplaints = [
        { id: 1, customerId: 108, vendorId: 104, date: '10-8-2024', issue: 'Incomplete Cleaning Service', action: 'Delete' },
        { id: 2, customerId: 112, vendorId: 107, date: '11-8-2024', issue: 'Overcharged', action: 'Delete' }
    ];
    const [searchTerm, setSearchTerm] = useState('');
    const [filteredComplaint, setFilteredComplaint] = useState(resolvedComplaints);
